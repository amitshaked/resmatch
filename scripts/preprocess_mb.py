...
output_dir = 'storage/data.mb.{}_{}'.format(rectification, color)
...
### 2014 dataset ###
base1 = 'storage/data.mb/unzip/vision.middlebury.edu/stereo/data/scenes2014/datasets'
...
print('done with 2014')
print(np.vstack(nnz_tr).shape)

### 2006 & 2005 dataset ###
for year in (2006, 2005):
    base1 = 'storage/data.mb/unzip/vision.middlebury.edu/stereo/data/scenes{}/HalfSize'.format(year)
    for dir in sorted(os.listdir(base1)):
...
for dir in ('conesH', 'teddyH'):
    print(dir)
    base1 = 'storage/data.mb/unzip/vision.middlebury.edu/stereo/data/scenes2003/{}'.format(dir)
...
### 2001 dataset ###
base1 = 'storage/data.mb/unzip/vision.middlebury.edu/stereo/data/scenes2001/data'
for dir in sorted(os.listdir(base1)):
    if dir == 'tsukuba':
...
base1 = 'storage/data.mb/unzip/MiddEval3'
